;; DrRacket pune la dispozitie o functie de tracing.  Asigurati-va ca aveti
;; limbajul selectat "Pretty Big" sau cel putin "MzScheme", si apoi apelati:
...
(define (factorial n) ;; acest apel produce redefinirea functiei factorial
  (fact-iter 1 1 n))
